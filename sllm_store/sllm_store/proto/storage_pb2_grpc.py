...
class StorageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPid = channel.unary_unary(
                '/storage.Storage/GetPid',
                request_serializer=sllm__store_dot_proto_dot_storage__pb2.GetPidRequest.SerializeToString,
                response_deserializer=sllm__store_dot_proto_dot_storage__pb2.GetPidResponse.FromString,
                )
...
def add_StorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'GetPid': grpc.unary_unary_rpc_method_handler(
            servicer.GetPid,
            request_deserializer=sllm__store_dot_proto_dot_storage__pb2.GetPidRequest.FromString,
            response_serializer=sllm__store_dot_proto_dot_storage__pb2.GetPidResponse.SerializeToString,
        ),
    }
...
class Storage(object):
    ...
    def GetPid(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/storage.Storage/GetPid',
            sllm__store_dot_proto_dot_storage__pb2.GetPidRequest.SerializeToString,
            sllm__store_dot_proto_dot_storage__pb2.GetPidResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)